...
{
    [TestClass]
    public class VehicleService_Get_Nearest_Vehicle_Should_Be_One
    {
        private readonly VehicleService _vehicleService;
        private readonly VehicleBinarySerializer _binarySerializer;

        public VehicleService_Get_Nearest_Vehicle_Should_Be_One()
        {
        ...
        [TestMethod]
        public void FindNearestVehiclePositionShouldBeOne()
        {
            ...
            var nearestVehicle = _vehicleService.GetNearestVehiclePosion(34.544909, -102.100843);
            Assert.AreEqual(1, nearestVehicle.PositionId);
        }
    }
}
